<nav class="bg-white border-gray-200">
  ...
  >
    ...
    <div
      class="hidden w-full md:block md:w-auto bg-slate-200 p-3 px-5 rounded-full bg-opacity-50"
      id="navbar-default"
    >
      <ul
    ...
    >
      <div
        class="mine w-12 h-12 bg-black rounded-full hover:bg-emerald-800"
      ></div></a
    >
  </div>
</nav>
...
<style>
  .mine {
    background-image: url(../../static/mylogo_white.png);
    background-size: 80%;
