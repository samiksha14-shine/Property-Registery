...
<div class="min-h-screen flex flex-col items-center justify-center py-12 bg-gradient-to-r from-black via-gray-800 to-black">
  <div class="text-center transform transition duration-500 hover:scale-105">
    <h1 class="text-5xl font-extrabold font-serif p-10 mb-3 text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-blue-500">
      Property Registry: <h2> Effortlessly issue and update property records! </h2>
    </h1>
    ...
    <!-- <div class="mt-10 space-x-4 flex justify-center">
      ...
      <a href="/repayment" class="flex items-center bg-gradient-to-r from-blue-500 to-red-500 text-white font-semibold px-6 py-3 rounded-lg shadow-lg hover:from-red-500 hover:to-blue-500 transform hover:-translate-y-1 transition duration-300">
        <span class="mr-2"></span> Property Issuance
      </a>
